<?php namespace App\Http\Controllers;
	...
	class AdminContentController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Wheel","name"=>"wheel","image"=>true];
			$this->col[] = ["label"=>"Outwheel","name"=>"outwheel","image"=>true];
			...
			$this->form[] = ['label'=>'Wheel','name'=>'wheel','type'=>'upload','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Outwheel','name'=>'outwheel','type'=>'upload','validation'=>'required','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Wheel","name"=>"wheel","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Outwheel","name"=>"outwheel","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
